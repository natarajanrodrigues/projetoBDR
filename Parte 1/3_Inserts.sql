...
INSERT INTO TELEFONE_FORNECEDOR VALUES('00.280.273/0007-22','4001-1235');
INSERT INTO TELEFONE_FORNECEDOR VALUES('00.280.273/0007-22','4004-1234');
...
INSERT INTO FORMA_PAGAMENTO VALUES (14, 'CARTÃO DE CRÉDITO 4X', 4);
INSERT INTO FORMA_PAGAMENTO VALUES (15, 'CARTÃO DE CRÉDITO 5X', 5);
INSERT INTO FORMA_PAGAMENTO VALUES (16, 'CARTÃO DE CRÉDITO 6X', 6);
INSERT INTO FORMA_PAGAMENTO VALUES (17, 'CARTÃO DE CRÉDITO 7X', 7);
INSERT INTO FORMA_PAGAMENTO VALUES (18, 'CARTÃO DE CRÉDITO 8X', 8);
INSERT INTO FORMA_PAGAMENTO VALUES (19, 'CARTÃO DE CRÉDITO 9X', 9);
INSERT INTO FORMA_PAGAMENTO VALUES (20, 'CARTÃO DE CRÉDITO 10X', 10);
...
-- TABLE VENDA Inserts
INSERT INTO VENDA(ID) VALUES ('VD-0000001');
INSERT INTO VENDA(ID) VALUES ('VD-0000002');
INSERT INTO VENDA(ID) VALUES ('VD-0000003');
INSERT INTO VENDA(ID) VALUES ('VD-0000004');
INSERT INTO VENDA(ID) VALUES ('VD-0000005');


-- TABLE ITEM_VENDA Inserts
--1
INSERT INTO ITEM_VENDA VALUES ('VD-0000001', 'P-000014', 1);
INSERT INTO ITEM_VENDA VALUES ('VD-0000001', 'P-000011', 1);
--2
INSERT INTO ITEM_VENDA VALUES ('VD-0000002', 'P-000012', 2);
INSERT INTO ITEM_VENDA VALUES ('VD-0000002', 'P-000016', 1);
INSERT INTO ITEM_VENDA VALUES ('VD-0000002', 'P-000009', 1);
--3
INSERT INTO ITEM_VENDA VALUES ('VD-0000003', 'P-000002', 1);
INSERT INTO ITEM_VENDA VALUES ('VD-0000003', 'P-000003', 2);
--4
INSERT INTO ITEM_VENDA VALUES ('VD-0000004', 'P-000004', 1);
--5
INSERT INTO ITEM_VENDA VALUES ('VD-0000005', 'P-000010', 2);


-- TABLE REALIZA_VENDA Inserts
INSERT INTO REALIZA_VENDA VALUES ('01/08/2015', TO_TIMESTAMP('08:59', 'hh:mm'), '18181818181', '77777777777', 'VD-0000001');
INSERT INTO REALIZA_VENDA VALUES ('25/09/2015', TO_TIMESTAMP('12:59', 'hh:mm'), '40540540540', '66666666666', 'VD-0000002');
INSERT INTO REALIZA_VENDA VALUES ('12/10/2015', TO_TIMESTAMP('12:34', 'hh:mm'), '11111111111', '99999999999', 'VD-0000003');
INSERT INTO REALIZA_VENDA VALUES ('15/10/2015', TO_TIMESTAMP('10:22', 'hh:mm'), '40540540540', '99999999999', 'VD-0000004');
INSERT INTO REALIZA_VENDA VALUES ('15/10/2015', TO_TIMESTAMP('11:38', 'hh:mm'), '33333333333', '99999999999', 'VD-0000005');

-- UPDATING VENDA. Setting VENDA, field STATUS to 'Finalizada' and setting 'FORMAPAGAMENTO' according the case
UPDATE VENDA SET STATUS='Finalizada', ID_FORMAPAGAMENTO=16 WHERE ID='VD-0000001';
UPDATE VENDA SET STATUS='Finalizada', ID_FORMAPAGAMENTO=60 WHERE ID='VD-0000002';
UPDATE VENDA SET STATUS='Finalizada', ID_FORMAPAGAMENTO=20 WHERE ID='VD-0000003';
UPDATE VENDA SET STATUS='Finalizada', ID_FORMAPAGAMENTO=20 WHERE ID='VD-0000004';
UPDATE VENDA SET STATUS='Finalizada', ID_FORMAPAGAMENTO=01 WHERE ID='VD-0000005';


-- TABLE NOTAFISCAL Inserts
INSERT INTO NOTAFISCAL(SERIE, ID_VENDA, DATA_EMISSAO, IMPOSTO) VALUES ('SERIE 1', 'VD-0000001', '01/08/2015', 0.38);
INSERT INTO NOTAFISCAL(SERIE, ID_VENDA, DATA_EMISSAO, IMPOSTO) VALUES ('SERIE E', 'VD-0000002', '25/09/2015', 0.38);
INSERT INTO NOTAFISCAL(SERIE, ID_VENDA, DATA_EMISSAO, IMPOSTO) VALUES ('SERIE 1', 'VD-0000003', '12/10/2015', 0.38);
INSERT INTO NOTAFISCAL(SERIE, ID_VENDA, DATA_EMISSAO, IMPOSTO) VALUES ('SERIE 1', 'VD-0000004', '15/10/2015', 0.38);
INSERT INTO NOTAFISCAL(SERIE, ID_VENDA, DATA_EMISSAO, IMPOSTO) VALUES ('SERIE E', 'VD-0000005', '15/10/2015', 0.38);